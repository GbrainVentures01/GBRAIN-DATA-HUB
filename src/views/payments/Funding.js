import { Button, Grid, Paper, Typography, Card, CardHeader } from '@mui/material';
                ...
                {method['Monify'] && (
                    <>
                        ...
                        <Typography
                            variant="subtile"
                            color="initial"
                            sx={{ fontSize: '1.1rem', fontWeight: 200, mr: 0.4, mt: 10, mb: 1.75 }}
                        >
                            You can choose any payment method you are comfortable with, after payment is successful, you will be redirected
                            back to our website.
                        </Typography>
                        <Formik
